...
def add_user(username, password):
    ...
    return_code = os.system('sudo {}/scripts/add_user.sh {} {}'.format(current_dir, username, password))
    if return_code != 0:
...
def change_password(username, password):
    current_dir = os.path.dirname(__file__)
    return_code = os.system('sudo {}/scripts/change_password.sh {} {}'.format(current_dir, username, password))
    if return_code != 0:

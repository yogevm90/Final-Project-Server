...
class1_query = {'name': 'math', 'id': '00003', 'teacher_name': 'idan57@gmail.com', 'description': 'math class', 'external_links': ['www.google.com', 'www.facebook.com'], 'homework_links': ['www.ynet.co.il'], 'updates': ['update 1', 'update 2'], 'test_ids': [], 'participants': ['yogevm90@gmail.com'], 'stream_paths': [{'user_id': '00001', 'video': '/project/upload/video/00001', 'audio': '/project/upload/audio/00001'}, {'user_id': '00002', 'video': '/project/upload/video/00002', 'audio': '/project/upload/audio/00002'}], 'day': '1', 'hour': '12', 'img_path': 'www.walla.co.il' }
